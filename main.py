...
def welcomeScreen():
    ...
    while True:
        for event in pygame.event.get():
            ...
            # if the user prsses space or up key, start the game for them
...
def getRandomPipe():
    """
    Generate positions of two pipes(one bottom striaght and one top rotated) for blitting on the screen
    """
...
if __name__=="__main__":
     ...
     pygame.display.set_caption('Flappy Bird by Twinkle')
